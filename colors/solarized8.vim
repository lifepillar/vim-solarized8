...
if &background ==# 'dark'
  ...
  if get(g:, 'solarized_statusline', '') ==# 'low'
    ...
    hi FloatBorder guifg=#073642 guibg=#586e75 gui=NONE cterm=NONE
    hi WinSeparator guifg=#073642 guibg=#586e75 gui=NONE cterm=NONE
  ...
  hi NormalFloat guifg=#93a1a1 guibg=#073642 gui=NONE cterm=NONE
  ...
  if get(g:, 'solarized_statusline', '') ==# 'low'
    ...
    hi FloatBorder guifg=#586e75 guibg=#93a1a1 gui=NONE cterm=NONE
    hi WinSeparator guifg=#586e75 guibg=#93a1a1 gui=NONE cterm=NONE
  ...
  hi VisualMode guifg=#d33682 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi CommandMode guifg=#d33682 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi NormalFloat guifg=#586e75 guibg=#eee8d5 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_statusline', '') ==# 'low'
      ...
      hi FloatBorder ctermfg=236 ctermbg=242 cterm=NONE
      hi WinSeparator ctermfg=236 ctermbg=242 cterm=NONE
    elseif get(g:, 'solarized_statusline', '') ==# 'flat'
    ...
    hi NormalFloat ctermfg=247 ctermbg=236 cterm=NONE
    ...
    if get(g:, 'solarized_statusline', '') ==# 'low'
      ...
      hi FloatBorder ctermfg=242 ctermbg=247 cterm=NONE
      hi WinSeparator ctermfg=242 ctermbg=247 cterm=NONE
    ...
    hi VisualMode ctermfg=162 ctermbg=230 cterm=reverse
    hi CommandMode ctermfg=162 ctermbg=230 cterm=reverse
    hi NormalFloat ctermfg=242 ctermbg=254 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_statusline', '') ==# 'low'
      ...
      hi FloatBorder ctermfg=0 ctermbg=10 cterm=NONE
      hi WinSeparator ctermfg=0 ctermbg=10 cterm=NONE
    elseif get(g:, 'solarized_statusline', '') ==# 'flat'
    ...
    hi NormalFloat ctermfg=14 ctermbg=0 cterm=NONE
    ...
    if get(g:, 'solarized_statusline', '') ==# 'low'
      ...
      hi FloatBorder ctermfg=10 ctermbg=14 cterm=NONE
      hi WinSeparator ctermfg=10 ctermbg=14 cterm=NONE
    ...
    hi VisualMode ctermfg=5 ctermbg=15 cterm=reverse
    hi CommandMode ctermfg=5 ctermbg=15 cterm=reverse
    hi NormalFloat ctermfg=10 ctermbg=7 cterm=NONE
