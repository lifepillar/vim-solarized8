" Name:         Solarized8 Light Low Contrast
" Description:  Precision colors for machines and people
" Author:       Ethan Schoonover
" Maintainer:   Lifepillar <lifepillar@lifepillar.me>
" Website:      https://github.com/lifepillar/vim-solarized8
" License:      OSI approved MIT license
" Last Updated: Sat Oct 28 17:20:34 2017

if !(has('termguicolors') && &termguicolors) && !has('gui_running')
      \ && (!exists('&t_Co') || &t_Co < (get(g:, 'solarized_use16', 0) ? 16 : 256))
  echoerr '[Solarized8 Light Low Contrast] There are not enough colors.'
  finish
endif
...
let g:colors_name = 'solarized8_light_low'
...
if !has('gui_running') && get(g:, 'solarized8_light_low_transp_bg', 0)
