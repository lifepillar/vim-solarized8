" Name:         Solarized 8 for Neovim - Flat
...
let s:italics = get(g:, 'solarized_italics', get(g:, 'solarized_italic', 1))
...
if &background ==# 'dark'
  ...
  hi FloatBorder guifg=#586e75 guibg=#073642 gui=NONE cterm=NONE
  hi NormalFloat guifg=#839496 guibg=#073642 gui=NONE cterm=NONE
  hi TermCursorNC guifg=#002b36 guibg=#586e75 gui=NONE cterm=NONE
  hi WinBar guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  hi WinBarNC guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  hi WinSeparator guifg=#586e75 guibg=#073642 gui=NONE cterm=NONE
  ...
  if !s:italics
    ...
    hi @markup.emphasis gui=NONE cterm=NONE
  endif
  if get(g:, 'solarized_extra_hi_groups', 1)
  ...
  hi FloatBorder guifg=#93a1a1 guibg=#eee8d5 gui=NONE cterm=NONE
  hi NormalFloat guifg=#657b83 guibg=#eee8d5 gui=NONE cterm=NONE
  hi TermCursorNC guifg=#fdf6e3 guibg=#93a1a1 gui=NONE cterm=NONE
  hi WinBar guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  hi WinBarNC guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  hi WinSeparator guifg=#93a1a1 guibg=#eee8d5 gui=NONE cterm=NONE
  hi @markup.strong guifg=fg guibg=NONE gui=bold cterm=bold
  hi @markup.emphasis guifg=fg guibg=NONE gui=italic cterm=italic
  if !s:italics
    hi Comment gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi FloatBorder ctermfg=242 ctermbg=236 cterm=NONE
    hi NormalFloat ctermfg=246 ctermbg=236 cterm=NONE
    hi TermCursorNC ctermfg=235 ctermbg=242 cterm=NONE
    hi WinBar ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinBarNC ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinSeparator ctermfg=242 ctermbg=236 cterm=NONE
    hi @markup.strong ctermfg=fg ctermbg=NONE cterm=bold
    hi @markup.emphasis ctermfg=fg ctermbg=NONE cterm=italic
    if !s:italics
      hi Comment cterm=NONE
      hi @markup.emphasis cterm=NONE
    endif
    if get(g:, 'solarized_extra_hi_groups', 1)
      hi! link vimVar Identifier
      hi! link vimFunc Function
    ...
    hi FloatBorder ctermfg=247 ctermbg=254 cterm=NONE
    hi NormalFloat ctermfg=66 ctermbg=254 cterm=NONE
    hi TermCursorNC ctermfg=230 ctermbg=247 cterm=NONE
    hi WinBar ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinBarNC ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinSeparator ctermfg=247 ctermbg=254 cterm=NONE
    hi @markup.strong ctermfg=fg ctermbg=NONE cterm=bold
    hi @markup.emphasis ctermfg=fg ctermbg=NONE cterm=italic
    if !s:italics
      hi Comment cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi FloatBorder ctermfg=10 ctermbg=0 cterm=NONE
    hi NormalFloat ctermfg=12 ctermbg=0 cterm=NONE
    hi TermCursorNC ctermfg=8 ctermbg=10 cterm=NONE
    hi WinBar ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinBarNC ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinSeparator ctermfg=10 ctermbg=0 cterm=NONE
    hi @markup.strong ctermfg=fg ctermbg=NONE cterm=bold
    hi @markup.emphasis ctermfg=fg ctermbg=NONE cterm=italic
    if !s:italics
      hi Comment cterm=NONE
    ...
    hi FloatBorder ctermfg=14 ctermbg=7 cterm=NONE
    hi NormalFloat ctermfg=11 ctermbg=7 cterm=NONE
    hi TermCursorNC ctermfg=15 ctermbg=14 cterm=NONE
    hi WinBar ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinBarNC ctermfg=NONE ctermbg=NONE cterm=bold
    hi WinSeparator ctermfg=14 ctermbg=7 cterm=NONE
    hi @markup.strong ctermfg=fg ctermbg=NONE cterm=bold
    hi @markup.emphasis ctermfg=fg ctermbg=NONE cterm=italic
    if !s:italics
      hi Comment cterm=NONE
