...
" Last Updated: Sun Aug 13 11:58:22 2023
...
let s:italics = get(g:, 'solarized_italics', 1)
...
if &background ==# 'dark'
  ...
  hi @text.strong guifg=fg guibg=NONE gui=bold cterm=bold
  hi @text.emphasis guifg=fg guibg=NONE gui=italic cterm=italic
  if !s:italics
    hi Comment gui=NONE cterm=NONE
    hi @text.emphasis gui=NONE cterm=NONE
  endif
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi @text.strong ctermfg=fg ctermbg=NONE cterm=bold
    hi @text.emphasis ctermfg=fg ctermbg=NONE cterm=italic
    if !s:italics
      hi Comment cterm=NONE
      hi @text.emphasis cterm=NONE
    endif
    hi! link TermCursor Cursor
